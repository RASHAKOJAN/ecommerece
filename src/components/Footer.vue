      ...
      <v-row>
        <v-col cols="12" sm="4">
          ...
          <v-card-text class="grey--text pt-0">
            © {{ new Date().getFullYear() }} — <strong>IdeaProject</strong>
          </v-card-text>
          ...
          <v-card-text class="grey--text">
            &#169; Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vitae quod, quidem ipsum doloremque labore non hic sit repudiandae quae, enim officiis quas dolores? Repellendus labore porro ducimus a alias impedit.
          </v-card-text>
        </v-col>
        <v-col cols="12" sm="2">
          <v-card-text class="white--text pt-0">
